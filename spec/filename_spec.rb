...
describe "Filename" do
  ...
  it "should be good" do
    expect(foobar).must_equal "foobar"
  end
  ...
  def data
    [
      ...
      [ 43,'##########-##.jpg', '1523059275-16.jpg', '(?i)(\d{10})-(?:\d+).jpg', 'TRUE', '1523059275' ],
      ...
      [ 34,'##########-#.jpg', '1523035601-2.jpg', '(?i)(\d{10})-(?:\d+).jpg', 'TRUE', '1523035601' ],
      [ 33,'sugarloaf##.jpg', 'sugarloaf18.jpg', '', '', '' ],
      [ 32,'########_######_###.jpg', '20230113_152749_001.jpg', '', '', '' ],
      ...
      [ 27,'img_########_######_###.jpg', 'IMG_20221104_212700_703.jpg', '', '', '' ],
      [ 27,'photo ##-##-#### ## ## ##.jpg', 'Photo 25-03-2015 14 22 51.jpg', '', '', '' ],
      [ 26,'dorm##.jpg', 'dorm82.jpg', '', '', '' ],
      [ 23,'########_######_##.jpg', '20220903_234858_01.jpg', '', '', '' ],
      ...
      [ 16,'####-##-##-##.jpg', '2017-08-25-13.jpg', '', '', '' ],
      [ 15,'####-##-##-##-##.jpg', '2017-09-15-22-40.jpg', '', '', '' ],
      [ 14,'####-##-##-######.jpg', '2023-05-23-174617.jpg', '', '', '' ],
      [ 14,'#.##.## ###.jpg', '3.19.06 015.jpg', '', '', '' ],
      [ 13,'####-##-## ##.##.##-#.mp#', '2017-09-03 11.29.57-6.mp4', '', '', '' ],
      [ 13,'screen shot ####-##-## at #.##.## pm.png', 'Screen Shot 2017-05-05 at 5.28.32 PM.png', '', '', '' ],
      ...
      [ 11,'screen shot ####-##-## at ##.##.## am.png', 'Screen Shot 2015-01-16 at 11.00.06 AM.png', '', '', '' ],
      [ 11,'screenshot_########-######_chrome.jpg', 'Screenshot_20220815-190823_Chrome.jpg', '', '', '' ],
